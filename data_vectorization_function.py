...
def vectorizeDataframe(dataframe):
  ...
  for col in dataframe.columns:
    if col == '1':
      dataframe[col] = dataframe[col].replace(mappingQuestion1)
    elif col == '2':
      dataframe[col] = dataframe[col].replace(mappingQuestion2)
    elif col == '3':
      dataframe[col] = dataframe[col].replace(mappingQuestion3)
    elif col == '5':
      dataframe[col] = dataframe[col].replace(mappingQuestion5)
    elif col == '6':
      dataframe[col] = dataframe[col].replace(mappingQuestion6)
    elif col == '7':
      dataframe[col] = dataframe[col].replace(mappingQuestion7)
    elif col == '8':
      dataframe[col] = dataframe[col].replace(mappingQuestion8)
    elif col == '9':
      dataframe[col] = dataframe[col].replace(mappingQuestion9)
    elif col == '10':
      dataframe[col] = dataframe[col].replace(mappingQuestion10)
    elif col == '13':
      dataframe[col] = dataframe[col].replace(mappingQuestion13)
    elif col == '14':
      dataframe[col] = dataframe[col].replace(mappingQuestion14)
    elif col == '25':
      dataframe[col] = dataframe[col].replace(mappingQuestion25)
    elif col == '26':
      dataframe[col] = dataframe[col].replace(mappingQuestion26)
    elif col == '27':
      dataframe[col] = dataframe[col].replace(mappingQuestion27)
    elif col == '28':
      dataframe[col] = dataframe[col].replace(mappingQuestion28)
    elif col == '29':
      dataframe[col] = dataframe[col].replace(mappingQuestion29)
    elif col == '30':
      dataframe[col] = dataframe[col].replace(mappingQuestion30)
    elif col == '33':
      dataframe[col] = dataframe[col].replace(mappingQuestion33)
    elif col == '34':
      dataframe[col] = dataframe[col].replace(mappingQuestion34)
    elif col == '61':
      dataframe[col] = dataframe[col].replace(mappingQuestion61)
    elif col == '62':
      dataframe[col] = dataframe[col].replace(mappingQuestion62)
    elif col == '40':
      dataframe[col] = dataframe[col].replace(mappingQuestion40)
    elif col == '41':
      dataframe[col] = dataframe[col].replace(mappingQuestion41)
    elif col == '43':
      dataframe[col] = dataframe[col].replace(mappingQuestion43)
    elif col == '44':
      dataframe[col] = dataframe[col].replace(mappingQuestion44)
    elif col == '45':
      dataframe[col] = dataframe[col].replace(mappingQuestion45)
    elif col == '50':
      dataframe[col] = dataframe[col].replace(mappingQuestion50)
    elif col == '51':
      dataframe[col] = dataframe[col].replace(mappingQuestion51)
    elif col == '52':
      dataframe[col] = dataframe[col].replace(mappingQuestion52)
    elif col == '54':
      dataframe[col] = dataframe[col].replace(mappingQuestion54)
