...
2. [Split the data into testing and training](#second)
3. [Logistic Regression](#third)
4. [Random Forest](#fourth)
5. [Decision Tree](#fifth)
"""
...
"""# Split data into testing set and trainng set <a name="second"></a>
...
"""# Logistic Regression <a name="third"></a>
