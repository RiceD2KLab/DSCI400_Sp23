...
def makeTextMatrix(df2016, df2017, df2018, df2019, df2020, df2021):
  ...
  df2016Filtered = filterFeatures(df2016)
  ...
  df2017Filtered = filterFeatures(df2017)
  ...
  df2018Filtered = filterFeatures(df2018)
  ...
  df2019Filtered = filterFeatures(df2019)
  ...
  df2020Filtered = filterFeatures(df2020)
  ...
  df2021Filtered = filterFeatures(df2021)
